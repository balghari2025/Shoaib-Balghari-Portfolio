                ...
                <div className='flex flex-col md:flex-row '>
                    ...
                    <div className='md:w-1/2 order-1 md:order-2 relative'>
                        <img
                            ref={imageRef}
                            src={Pic}
                            className='rounded-lg shadow-blue-400 md:w-[650px] md:h-[450px] mb-10'
                            alt=""
                        />
                        <div
                            ref={iconRef}
                            className='absolute shadow-blue-950 top-[55%] left-[41%] text-6xl md:top-[60%] md:left-[38%] md:text-9xl text-blue-600'
                        >
                            <FaReact />
                        </div>
                    </div>
